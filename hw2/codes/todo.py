...
# TODO manage turns and prevent starvation
# FIXME I've forgot to check for time out when an ack is retrieved but is late!
# TODO change state when exceeding ss_threshold
